					...
					<div class="menu-center collapse navbar-collapse">
						<ul class="ttr_menu_items nav navbar-nav navbar-right">
							...
							<li class="ttr_menu_items_parent dropdown">
								<a href="info" class="ttr_menu_items_parent_link">
									<span class="menuchildicon"></span>교회소개
								</a>
								<hr class="horiz_separator" />
							</li>
							<li class="ttr_menu_items_parent dropdown">
								<a href="customer/notice/list?b_name=jubo" class="ttr_menu_items_parent_link">
									<span class="menuchildicon"></span>예배
								</a>
								<hr class="horiz_separator" />
							</li>
							<li class="ttr_menu_items_parent dropdown">
								<a href="map" class="ttr_menu_items_parent_link">
